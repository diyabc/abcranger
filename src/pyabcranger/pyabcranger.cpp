...
PYBIND11_MODULE(pyabcranger, m) { 
    ...
    py::class_<ModelChoiceResults>(m,"modelchoice_results")
        ...
        .def_readwrite("oob_votes",&ModelChoiceResults::oob_votes)
        .def_readwrite("pudlo_weights",&ModelChoiceResults::pudlo_weights)
        .def_readwrite("luhardin_weights",&ModelChoiceResults::luhardin_weights)        
        .def_readwrite("pudlo_weights_all",&ModelChoiceResults::pudlo_weights_all)
