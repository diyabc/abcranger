---
title: "A demo of abcranger python package in R"
author: "François-David Collin"
format:
    gfm: default
---

The following demo needs hdf5r, ggplot2, tidyverse and reticulate packages.

::: {.callout-note}
Hdf5 needs to be installed on the system. See [here](https://support.hdfgroup.org/HDF5/release/obtain5.html) for more information.
If you are on a Mac, you can install it with [homebrew](https://brew.sh/):
...
::: {.callout-tip}
If you have custom python environment (conda or virtualenv), you may need to specify it, see [official reticulate documentation](https://rstudio.github.io/reticulate/articles/python_packages.html).
:::
